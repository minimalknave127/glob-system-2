...
export const MUIDataTableLocaleCZ = {
  textLabels: {
    body: {
      noMatch: "Žádné položky nebyly nalezeny",
      toolTip: "Řadit",
      columnHeaderTooltip: (column) => `Řadit podle ${column.label}`,
    },
    pagination: {
      next: "Další stránka",
      previous: "Předchozí stránka",
      rowsPerPage: "Položek na stránku:",
      displayRows: "z",
    },
    toolbar: {
      search: "Hledat",
      downloadCsv: "Stáhnou jako .CSV",
      print: "Tisknout",
      viewColumns: "Zobrazit sloupce",
      filterTable: "Filtrovat tabulku",
    },
    filter: {
      all: "Vše",
      title: "FILTRY",
    ...
    selectedRows: {
      text: "řádků vybráno",
      delete: "Smazat",
      deleteAria: "Smazat vybrané položky",
    },
  },
};
